...
namespace QueueSystem.Clients.QueueSystemHostReference {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="QueueSystem.Contract", ConfigurationName="QueueSystemHostReference.Contract", CallbackContract=typeof(QueueSystem.Clients.QueueSystemHostReference.ContractCallback), SessionMode=System.ServiceModel.SessionMode.Required)]
    public interface Contract {
        ...
        void ReceiveQueueNo(int userId, string queueNo);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="QueueSystem.Contract/Contract/ReceiveQueueNo")]
        System.Threading.Tasks.Task ReceiveQueueNoAsync(int userId, string queueNo);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ContractChannel : QueueSystem.Clients.QueueSystemHostReference.Contract, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ContractClient : System.ServiceModel.DuplexClientBase<QueueSystem.Clients.QueueSystemHostReference.Contract>, QueueSystem.Clients.QueueSystemHostReference.Contract {
        ...
        public void ReceiveQueueNo(int userId, string queueNo) {
            base.Channel.ReceiveQueueNo(userId, queueNo);
        }
        
        public System.Threading.Tasks.Task ReceiveQueueNoAsync(int userId, string queueNo) {
            return base.Channel.ReceiveQueueNoAsync(userId, queueNo);
        }
